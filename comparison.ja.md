...
layout: page
title: 比較
description: "円グラフ・棒グラフ・折れ線グラフと平行座標プロットの比較 — 多次元データ可視化の最適解"
...
**データが3次元以上、100行以上あるなら、平行座標プロットでデータを探索してみるべきだ。** 何を見逃しているか分からないかもしれない。このプロジェクトは[オープンソース](https://github.com/untra/parallel)で公開している。コードを読み、独自のデータに応用し、コントリビューションしてほしい。
