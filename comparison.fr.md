...
**Ce qui empêche le chaos visuel, c'est l'interactivité.** Le brossage d'un axe filtre les données sur une plage. La coloration par champ révèle les groupes et les valeurs aberrantes. Le survol met en évidence un chemin unique à travers toutes les dimensions. Un diagramme en coordonnées parallèles statique est écrasant ; mais un diagramme interactif est un outil perspicace pour la découverte.
...
J'imagine un futur avec l'IA où le travail restant pour les humains sera très difficile et exigeant, et les énigmes scientifiques à explorer nécessiteront des humains capables d'explorer l'information à la même vitesse. J'imagine que le diagramme en coordonnées parallèles sera important pour notre avenir.

**Si vos données ont plus de trois dimensions et plus d'une centaine de lignes, vous devriez essayer un diagramme en coordonnées parallèles pour explorer vos données.** Vous ne savez peut-être pas ce que vous manquez.
